...
PAGES = {
    ...
    "design": dict(
        title="スカジャンの柄のデザイン依頼｜柄だけをお納めします｜横地広海知",
        desc="オリジナルスカジャンの柄のデザインだけをご依頼いただけます。生産ラインをお持ちのブランド向けに、柄のイラストデータのみを納品。GU・PUMAへの柄提供実績。スウェットやTシャツなどスカジャン以外のアイテムの柄も承ります。刺繍化を前提とした線で描きます。",
        nav="柄のデザイン",
        crumbs=[("柄のデザイン", "design.html")],
        service="スカジャンの柄のデザイン制作（柄データのみの納品）",
        extra=[PERSON],
    ),
    "order": dict(
